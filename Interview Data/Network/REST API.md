...
**REST**(Representational State Transfer)란 웹을 위한 네트워크 기반 아키텍쳐 스타일입니다. 아키텍쳐 스타일이란 그 스타일을 따르는 아키텍처가 지켜야하는 제약조건들의 집합입니다.
...
| Method | 역할                                                                                                  |
| ------ | ----------------------------------------------------------------------------------------------------- |
| POST   | POST를 통해 해당 URI를 요청하면 리소소를 생성합니다.                                                  |
| GET    | GET를 통해 해당 리소스를 조회합니다. 리소스를 조회하고 해당 도큐먼트에 대해 자세한 정보를 가져옵니다. |
